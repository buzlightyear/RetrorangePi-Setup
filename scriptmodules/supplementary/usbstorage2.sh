...
cp /home/pi/RetroPie-Setup/scriptmodules/supplementary/usbstorage/bindall.sh /etc/bindall.sh
chmod +x /etc/bindall.sh
if grep -q "/mnt/usb" "/etc/fstab"; then
...
function bindall(){
cp /home/pi/RetroPie-Setup/scriptmodules/supplementary/bindall.sh /etc/init.d/bindall.sh 
usb_path=/mnt/usb
